...
(: It doesn't seem to be a problem that the quotes in the onclick value get escaped :)
      ...
      return (            
        ...
        <br/>,        
        <img src="http://maps.googleapis.com/maps/api/staticmap?center={$orgRecord/dwc_decimalLatitude/text()},{$orgRecord/dwc_decimalLongitude/text()}&amp;zoom=14&amp;size=300x300&amp;markers=color:green%7C{$orgRecord/dwc_decimalLatitude/text()},{$orgRecord/dwc_decimalLongitude/text()}&amp;sensor=false&amp;key=AIzaSyAg2k8xoGmGP6KtvReK13JsNgRLMjRQCDc"/>,
        <img src="http://maps.googleapis.com/maps/api/staticmap?center={$orgRecord/dwc_decimalLatitude/text()},{$orgRecord/dwc_decimalLongitude/text()}&amp;maptype=hybrid&amp;zoom=18&amp;size=300x300&amp;markers=color:green%7C{$orgRecord/dwc_decimalLatitude/text()},{$orgRecord/dwc_decimalLongitude/text()}&amp;sensor=false&amp;key=AIzaSyAg2k8xoGmGP6KtvReK13JsNgRLMjRQCDc"/>,
        <br/>,
        <br/>
      ),
